...
int main() {
    ...
    case 1:
        ...
        case 1:
            ...
            {
                Player gWilliams(7, 19, 10, 7, 5, 2, 11,
                    2, 0, 0, 2, 0, 0, 0,
                    1, 4, 5, 5, 6, 2, 6,
                    40.0, 71.4, 33.3, 12.5, 40.0, 0, 62.5,
                    5, 7, 6, 8, 5, 2, 8,
                    2, 5, 2, 1, 2, 0, 5);
            ...
            {
                Player mSmart(0, 24, 16, 0, 5, 14, 24,
                    0, 12, 7, 0, 4, 3, 5,
                    0, 9, 4, 0, 5, 4, 9,
                    0, 36.4, 54.5, 0, 20.0, 26.7, 36.4,
                    0, 22, 11, 0, 5, 15, 22,
                    0, 8, 6, 0, 1, 4, 8);
            ...
            {
                Player rWilliams(18, 5, 0, 12, 6, 12, 2,
                    1, 0, 0, 0, 0, 0, 1,
                    9, 4, 0, 9, 10, 1, 3,
                    75.0, 66.7, 0, 80.0, 100.0, 71.4, 0,
                    8, 3, 0, 5, 2, 7, 2,
                    6, 2, 0, 4, 2, 5, 0);
            ...
            if (nameChoice == "Derrick White")
            {
                ...
                Player dWhite(3, 0, 0, 13, 14, 22, 8,
                    4, 0, 1, 6, 5, 5, 1,
                    0, 0, 2, 8, 1, 3, 3, 
                    25.0, 0.0, 0.0, 28.6, 75.0, 50.0, 37.5,
                    4, 0, 2, 14, 8, 14, 8,
                    1, 0, 0, 4, 6, 7, 3);
